        ...
        <div className="space-y-6">
          <Card className="border-yellow-500/20 bg-yellow-500/5">
            ...
            <CardContent className="space-y-4">
              ...
              <p>
                BeatAni is a frontend demonstration project showcasing modern web development practices, API integration, and user interface design. We are NOT a commercial anime streaming service.
              </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                BeatAni respects the intellectual property rights of others and expects its users to do the same. We comply with the provisions of the Digital Millennium Copyright Act (DMCA) and other applicable copyright laws.
              </p>
              <p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                BeatAni functions as a frontend aggregator that:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                If you are a copyright owner or an agent thereof and believe that any content on BeatAni infringes upon your copyrights, you may submit a takedown notification.
              </p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                BeatAni will terminate user accounts of repeat copyright infringers in appropriate circumstances. Users who repeatedly upload copyrighted material or post infringing links may have their accounts suspended or permanently banned.
              </p>
            </CardContent>
          </Card>
