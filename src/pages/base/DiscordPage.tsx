...
const SUPPORT_URL     = 'https://t.me/BeatAnime';
...
const FEATURES = [
  ...
  },
  {
    ...
    title: 'Anime Search',
    desc:  'Look up any anime or character with rich embeds. Direct links to watch on BeatAni.',
...
const COMMANDS = [
  ...
  { name: '/mod seal',       desc: 'Kick a user (BeatAni-style)' },
          ...
          <div className="relative px-8 py-12 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-muted-foreground text-base max-w-xl">
                The ultimate anime Discord bot — gacha pulls, PvP battles, solo RPG, economy, trivia, moderation, and more. Built for BeatAni.
              </p>
            ...
            <div className="mt-5 rounded-xl bg-[#5865F2]/10 border border-[#5865F2]/20 p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Add BeatAni Bot and unlock the full anime experience for your community.
                </p>
              </div>
              <Button
                asChild
