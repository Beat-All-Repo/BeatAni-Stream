...
import { MultiApiManager } from '@/components/admin/MultiApiManager';
...
const navItems = [
  ...
  { value: 'multi-api', label: 'API Load Balancer', icon: Server, roles: ['admin'] },
